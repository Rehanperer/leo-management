    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="border-b border-gray-200 mb-6 overflow-x-auto no-scrollbar">
                <nav className="-mb-px flex space-x-8 min-w-max px-4 md:px-0">
                    {['overview', 'transactions', 'projects', 'budgeting'].map((tab) => (
                        <button
                            key={tab}
                            onClick={() => setActiveTab(tab as any)}
                            className={`pb-4 px-1 border-b-2 font-medium text-sm capitalize whitespace-nowrap ${activeTab === tab
