        ...
        try {
            ...
            const updatedEvent = await prisma.event.update({
                ...
                data: {
                    ...
                    impactMetrics: impactMetrics ? (typeof impactMetrics === 'string' ? impactMetrics : JSON.stringify(impactMetrics)) : undefined,
                    collaborators: collaborators ? (typeof collaborators === 'string' ? collaborators : JSON.stringify(collaborators)) : undefined,
