...
export const CRTEffect = () => (
    <div className="pointer-events-none fixed inset-0 z-50 overflow-hidden h-full w-full">
        ...
        {/* Flicker/Noise (Subtle & Slower Pulse) */}
        <div className="absolute inset-0 bg-white opacity-[0.02] pointer-events-none animate-[pulse_4s_cubic-bezier(0.4,0,0.6,1)_infinite]" />
        {/* Vignette */}
